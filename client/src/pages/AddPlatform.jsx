...
const AddPlatform = () => {
  ...
  const [isConnecting, setIsConnecting] = useState({ credly: false, leetcode: false })
  const [isVerifying, setIsVerifying] = useState({ credly: false, leetcode: false })
  const [verificationData, setVerificationData] = useState({ credly: null, leetcode: null })
  const [copiedCode, setCopiedCode] = useState({ credly: false, leetcode: false })
  const [verifiedPlatforms, setVerifiedPlatforms] = useState({ credly: null, leetcode: null })
  const [isDeleting, setIsDeleting] = useState({ credly: false, leetcode: false })
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-8">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6">
                {/* Credly Section */}
                <div className="relative overflow-hidden rounded-xl p-6 shadow-[12px_12px_30px_#111,-12px_-12px_30px_#222]">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-3 min-w-0 flex-shrink-0">
                        <div className="w-8 h-8 bg-black border border-gray-800 rounded-lg flex items-center justify-center shadow-[4px_4px_12px_#111,-4px_-4px_12px_#222]">
