...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden bottom-0 left-0 right-0 border-t-2 border-white/20 bg-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-3">
          ...
          <div className="flex items-center gap-6">
            {/* GitHub */}
            <a href="https://github.com/Priyanshi2342" target="_blank" rel="noreferrer" aria-label="GitHub">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/priyanshi1111/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
              <svg strokeLinejoin="round" strokeLinecap="round" strokeWidth={2} stroke="currentColor" fill="none" viewBox="0 0 24 24" className="w-5 stroke-white/80 hover:stroke-white transition-colors">
